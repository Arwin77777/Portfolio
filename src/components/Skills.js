            ...
            <div className="row">
                <div className="col-12">
                    <div className="skill-bx wow zoomIn">
                        <h2>Skills</h2>
                        <p>A versatile professional with expertise in frontend and backend development, data science, and machine learning. Proficient in a wide range of programming languages, frameworks, and tools, with a strong foundation in problem-solving and object-oriented programming principles.</p>
                        <Carousel responsive={responsive} infinite={true} className="owl-carousel owl-theme skill-slider">
                            ...
                            <div className="item">
                            <img width="96" height="96" src="https://img.icons8.com/color/96/amazon-web-services.png" alt="amazon-web-services"/>
                            <h5>AWS</h5>
                            </div>
                            <div className="item">
